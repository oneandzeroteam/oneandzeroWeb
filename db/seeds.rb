...
Project.create(title: "하나와영 웹프로젝트", description: "하나와영 공식 웹페이지 프로젝트 Ruby on Rails", is_ongoing: true)
Project.create(title: "TEAM RASPBERRY", description: "라즈베리 파이를 이용한 패러럴 컴퓨팅 프로젝트", is_ongoing: false)